from PyQt5.QtWidgets import QVBoxLayout, QLabel, QLabel, QPushButton, QWidget, QLineEdit, QHBoxLayout, QMainWindow, QFrame, QGridLayout, QComboBox, QTableWidget, QTableWidgetItem, QHeaderView
...
class HomeScreen(QMainWindow):
    def __init__(self):
        ...
        self.bth_home = QPushButton("Home")
        self.bth_add = QPushButton("Add Vehicle")
        self.bth_manage = QPushButton("Manage Vehicle")
        self.bth_history = QPushButton("History")

        menu_vertical_layout.setContentsMargins(0,0,0,0)
        menu_vertical_layout.setSpacing(0)
        self.bth_home.setStyleSheet("width:200px; height: 160px; font-size: 20px; background: blue; color: #fff; font-weight:bold; border:1px solid white")
        self.bth_add.setStyleSheet("width:200px; height: 160px; font-size: 20px; background: orange; color: #fff; font-weight:bold; border:1px solid white")
        self.bth_manage.setStyleSheet("width:200px; height: 160px; font-size: 20px; background: orange; color: #fff; font-weight:bold; border:1px solid white")
        self.bth_history.setStyleSheet("width:200px; height: 160px; font-size: 20px; background: orange; color: #fff; font-weight:bold; border:1px solid white")

        self.bth_home.clicked.connect(self.showHome)
        self.bth_add.clicked.connect(self.showAdd)
        self.bth_manage.clicked.connect(self.showManage)
        self.bth_history.clicked.connect(self.showHistory)

        menu_frame = QFrame()
        menu_vertical_layout.addWidget(self.bth_home)
        menu_vertical_layout.addWidget(self.bth_add)
        menu_vertical_layout.addWidget(self.bth_manage)
        menu_vertical_layout.addWidget(self.bth_history)
    ...
    def showHistory(self):
        self.bth_home.setStyleSheet("width:200px; height: 160px; font-size: 20px; background: orange; color: #fff; font-weight:bold; border:1px solid white")
        self.bth_add.setStyleSheet("width:200px; height: 160px; font-size: 20px; background: orange; color: #fff; font-weight:bold; border:1px solid white")
        self.bth_manage.setStyleSheet("width:200px; height: 160px; font-size: 20px; background: orange; color: #fff; font-weight:bold; border:1px solid white")
        self.bth_history.setStyleSheet("width:200px; height: 160px; font-size: 20px; background: blue; color: #fff; font-weight:bold; border:1px solid white")
    ...
    def showManage(self):
        self.bth_home.setStyleSheet("width:200px; height: 160px; font-size: 20px; background: orange; color: #fff; font-weight:bold; border:1px solid white")
        self.bth_add.setStyleSheet("width:200px; height: 160px; font-size: 20px; background: orange; color: #fff; font-weight:bold; border:1px solid white")
        self.bth_manage.setStyleSheet("width:200px; height: 160px; font-size: 20px; background: blue; color: #fff; font-weight:bold; border:1px solid white")
        self.bth_history.setStyleSheet("width:200px; height: 160px; font-size: 20px; background: orange; color: #fff; font-weight:bold; border:1px solid white")
    ...
    def showAdd(self):
        self.bth_home.setStyleSheet("width:200px; height: 160px; font-size: 20px; background: orange; color: #fff; font-weight:bold; border:1px solid white")
        self.bth_add.setStyleSheet("width:200px; height: 160px; font-size: 20px; background: blue; color: #fff; font-weight:bold; border:1px solid white")
        self.bth_manage.setStyleSheet("width:200px; height: 160px; font-size: 20px; background: orange; color: #fff; font-weight:bold; border:1px solid white")
        self.bth_history.setStyleSheet("width:200px; height: 160px; font-size: 20px; background: orange; color: #fff; font-weight:bold; border:1px solid white")
    ...
    def addHomePageData(self):
        ...
        # label = QLabel("Home")
        # label.setStyleSheet("background:black; color:#fff; font-size:18px; font-weight:bold; width: 500px; height: 30px; padding 10px")
    ...
    def addAddStudentPage(self):
        ...
        vtype = QComboBox()
        vtype.setStyleSheet("color:#fff; padding:8px 0px; font-size:20px; border: 1px solid #fff")
    ...
    def addManagePage(self):
        ...
        for smalldata in data:
            ...
            self.table.setItem(loop, 4, QTableWidgetItem(str(smalldata[7]) +' Wheeler' ))
            self.table.setItem(loop, 5, QTableWidgetItem(str(smalldata[3])))
            self.button_exit = QPushButton("Exit")
            self.button_exit.setStyleSheet("color:#000; padding:8px 0px; font-size:20px; background:green; border: 1px solid white")
    ...
    def refreshHistory(self):
        ...
        for smalldata in data:
            ...
            self.table1.setItem(loop, 4, QTableWidgetItem(str(smalldata[7]) +' Wheeler' ))
    ...
    def addHistoryPage(self):
        ...
        button = QPushButton("Refresh")
        button.setStyleSheet("color:#000; padding:8px 0px; font-size:20px; background:green; border:1px solid white")
